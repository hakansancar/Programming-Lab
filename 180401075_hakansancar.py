file = open("C:/Users/sncrh/Desktop/data_files/input.txt", "r", encoding="utf-8")
file1 = open("C:/Users/sncrh/Desktop/data_files/1.txt", "r")
kelimeListe = dict()
...
for i in file:
    ...
    if(len(listInput)<=5):
         ...
         while(fileCounter<=10):
             fileString = "C:/Users/sncrh/Desktop/data_files/"+str(fileCounter)+".txt"
    ...
    f = open("C:/Users/sncrh/Desktop/data_files/output.txt", "a")
